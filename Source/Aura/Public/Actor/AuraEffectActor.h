...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Applied Effects|Singular")
	TSubclassOf<UGameplayEffect> InstantGameplayEffectClass;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Applied Effects|Singular")
	EEffectApplicationPolicy InstantEffectApplicationPolicy = EEffectApplicationPolicy::DoNotApply;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Applied Effects|Multiple")
	TArray<TSubclassOf<UGameplayEffect>> InstantGameplayEffectClasses;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Applied Effects|Multiple")
	EEffectApplicationPolicy InstantEffectsApplicationPolicy = EEffectApplicationPolicy::DoNotApply;
