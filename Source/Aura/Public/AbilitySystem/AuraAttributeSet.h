...
// typedef is specific to the FGameplayAttribue() signature, but TStaticFuncPtr is generic to any signature chosen
...
public:
	...
	UFUNCTION()
	void OnRep_CriticalHitChance(const FGameplayAttributeData& OldCritChance) const;

	UFUNCTION()
	void OnRep_CriticalHitDamage(const FGameplayAttributeData& OldCritDamage) const;

	UFUNCTION()
	void OnRep_CriticalHitResistance(const FGameplayAttributeData& OldCritResistance) const;
